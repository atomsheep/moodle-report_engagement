...
$string['message_table_heatmap_help'] = 'Toggle to show or hide heatmap - darker coloration tends to indicate more negative metrics.';
$string['message_table_filter_column'] = 'Filter';
$string['message_table_show_checkbox'] = 'Show';
